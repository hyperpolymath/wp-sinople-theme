...
:experimental:
:url-github: https://github.com/hyperpolymath/wp-sinople-theme
:url-gitlab: https://gitlab.com/hyperpolymath/wp-sinople-theme
:url-bitbucket: https://bitbucket.org/hyperpolymath/wp-sinople-theme
:url-codeberg: https://codeberg.org/hyperpolymath/wp-sinople-theme

Sinople WordPress theme package
...
wp-sinople-theme is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
